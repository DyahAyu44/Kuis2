...
<html>
<head>
	<title>Sistem Informasi Penyewaan Mobil</title>
	...
	<div id="container">
		...
		<div id="sidebar">
			...
			<ul>
				...
				<li><a href="index.php?p=mobil">Data Mobil</a></li>
			</ul>
			<p class="label-navigasi">Data Transaksi</p>
			<ul>
				<li><a href="index.php?p=transaksi">Transaksi Penyewaan</a></li>
			</ul>
		...
		<div id="footer"><h3>Sistem Informasi Penyewaan Mobil </h3></div>
	</div>
</body>
</html>
<?php
